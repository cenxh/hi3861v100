...
static void E53IS1IoInit(void)
{
    ...
    hi_io_set_func(WIFI_IOT_IO_NAME_GPIO_8, WIFI_IOT_IO_FUNC_GPIO_8_PWM1_OUT); // 设置GPIO_8引脚复用功能为PWM
    ...
    hi_io_set_func(WIFI_IOT_IO_NAME_GPIO_7, WIFI_IOT_IO_FUNC_GPIO_7_GPIO);
    IoTGpioSetDir(WIFI_IOT_IO_NAME_GPIO_7, IOT_GPIO_DIR_IN); // 设置GPIO_7为输入模式
    IoTGpioSetPull(WIFI_IOT_IO_NAME_GPIO_7, IOT_IO_PULL_UP);
}
